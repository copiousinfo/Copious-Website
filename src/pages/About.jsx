export default function About() {
  return (
    <div className="pt-32 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[80vh] flex flex-col justify-center">
      <div className="max-w-3xl">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">About Copious</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800">
            ...
            <p className="text-slate-400 text-sm">We cut out the bloat so you can focus on what matters most: your product.</p>
          </div>
          <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800">
            ...
            <p className="text-slate-400 text-sm">Everything you need to launch confidently, built right in.</p>
          </div>
        </div>
      </div>
    </div>

...
if (!API_URL) {
  console.error(
    "[Contact Form] VITE_API_URL is not defined. Check your .env file.",
  );
}
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    const attempt = () => axios.post(API_URL, payload, { timeout: 15000 });
    ...
    try {
      ...
      try {
        ...
        if (isRetryable(firstErr)) {
          console.warn(
            "[Contact Form] First attempt failed, retrying in 2 s…",
            firstErr.code,
          );

...
export default function AzureCloudDetail() {
  ...
  return (
    <div className="w-full pt-[92px] bg-white">
      ...
      {/* ── What Is Azure Cloud ──────────────────────────────── */}
      <section className="w-full bg-white py-12 sm:py-10 lg:py-14">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            {/* Left: Text */}
            <div>
              <h2 className="text-[#1f2937] text-[26px] sm:text-[28px] lg:text-[30px] font-bold mb-5 leading-snug text-center sm:text-left">
                What Is Azure Cloud?
              </h2>
              <div className="space-y-4">
                <p className="text-[#4b5563] text-[14px] sm:text-[15px] leading-[1.8] text-center">
                  Azure is a cloud computing platform and service created by
                  Microsoft. It provides a range of cloud services, including
                  those for computing, analytics, storage, and networking. Users
                  can choose and configure these services to develop and scale
                  new applications, or run existing applications, in the public
                  cloud.
                </p>
                <p className="text-[#4b5563] text-[14px] sm:text-[15px] leading-[1.8] text-center">
                  The Azure cloud platform offers over 200 products and cloud
                  services aimed at assisting you in developing innovative
                  solutions to address current issues and shape the future.
                  Develop, operate, and oversee applications across various
                  clouds, on-premises, and at the edge, utilizing the tools and
                  frameworks that best suit your needs.
                </p>
              </div>
            </div>
            {/* Right: Image */}
            <div className="w-full">
              <img
                ...
                className="w-full h-[250px] sm:h-[290px] lg:h-[320px] object-cover bg-[#f8f9fa] rounded-xl shadow-sm"
              />
            </div>
          </div>
        </div>
      ...
      {/* ── Our Values ───────────────────────────────────────── */}
      <section className="w-full bg-[#eaecee] py-4 sm:py-10 lg:py-12">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-16">
          <h2 className="text-[#1f2937] text-[24px] sm:text-[30px] lg:text-[36px] font-bold text-center mb-7 sm:mb-10">
            Our Values
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8">
            {values.map((val, i) => (
              ...
              >
                ...
                <h3 className="text-[#1f2937] font-bold text-[16px] sm:text-[17px] mb-3">
                  {val.title}
                </h3>
      ...
      <section className="w-full bg-white py-12 sm:py-10 lg:py-14">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-16">
          <h2 className="text-[#1f2937] text-[24px] sm:text-[30px] lg:text-[36px] font-bold text-center mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-12">
            {features.map((feat, i) => (
              <div
                key={i}
                className="site-card bg-white rounded-xl border border-gray-200 p-6 shadow-lg flex flex-col cursor-pointer"
              >
                <h3 className="text-[#1f2937] font-bold text-[15px] sm:text-[16px] mb-3">
                  {feat.title}
                </h3>
                <p className="text-[#4b5563] text-[13px] sm:text-[14px] leading-[1.8] mb-5 flex-grow">
                  {feat.desc}
                </p>
                <button
